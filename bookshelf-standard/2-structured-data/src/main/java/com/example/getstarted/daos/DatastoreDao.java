...
public class DatastoreDao implements BookDao {
  ...
  public Long createBook(Book book) {
    ...
    incBookEntity.setProperty(Book.AUTHOR, book.getAuthor());           // Add Property ("author", book.getAuthor())
  ...
  public Book readBook(Long bookId) {
    try {
      Entity bookEntity = datastore.get(KeyFactory.createKey(BOOK_KIND, bookId)); // Load an Entity for Key(id)
